package com.microservices.demo.producer.config.impl;
...
public class TwitterKafkaProducer implements KafkaProducer<Long, TwitterAvroModel> {
    ...
    public void send(String topicName, Long key, TwitterAvroModel message) {
        ...
        ListenableFuture<SendResult<Long, TwitterAvroModel>> kafkaResultFuture = (ListenableFuture<SendResult<Long, TwitterAvroModel>>) kafkaTemplate.send(topicName, key, message);
